# RailsAdmin config file. Generated on November 28, 2011 17:12
...
RailsAdmin.config do |config|
  ...
  config.excluded_models = [AuthToken, Sponsorship]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Agency, Outlet, Sponsorship]

  # Application wide tried label methods for models' instances
  config.label_methods << :service_url
  ...
  config.model Outlet do
    ...
    list do
      ...
      field :agencies, :has_many_association
  ...
  # config.model Sponsorship do
  #   # Found associations:
  #     field :outlet, :belongs_to_association 
  #     field :agency, :belongs_to_association   #   # Found columns:
  #     field :id, :integer 
  #     field :outlet_id, :integer         # Hidden 
  #     field :agency_id, :integer         # Hidden 
  #     field :created_at, :datetime 
  #     field :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
