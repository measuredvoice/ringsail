...
json.results do 
  json.array! @galleries do |gallery|
    json.partial! "digital_registry/v1/shared/gallery", gallery: gallery
      ...
      json.array! gallery.gallery_items do |gallery_item|
        if gallery_item.item.published
          if gallery_item.item.class == MobileApp
            ...
            json.partial! "digital_registry/v1/shared/mobile_app", mobile_app: gallery_item.item.published, show_versions: true
          else
            json.type "Social Media"
            json.partial! "digital_registry/v1/shared/social_media", outlet: gallery_item.item.published
          end
        end
      end
    end
